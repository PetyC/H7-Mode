 ...
 * @LastEditTime: 2022-08-22 17:02:40
 */
#include "bsp_Demo.h"
 ...
 * @return {*}
 */
void Bsp_LCD_DrawPoint(uint16_t x, uint16_t y, uint16_t Data)
{
...
static uint8_t LCD_TX_DMA_FLAG = 0;
 ...
 * @return {*}
 */
void Bsp_LCD_DisplayImages(uint16_t *Images)
{
  Bsp_LCD_SetRegion(0, 0, X_MAX_PIXEL - 1, Y_MAX_PIXEL - 1);
  LCD_DC_High();
