...
void setup_scr_Wifi_screen(lv_ui *ui){
	...
	lv_obj_set_scrollbar_mode(ui->Wifi_screen_label_1, LV_SCROLLBAR_MODE_OFF);
	...
	lv_style_set_text_line_space(&style_wifi_screen_label_1_main_main_default, 0);
	lv_style_set_text_align(&style_wifi_screen_label_1_main_main_default, LV_TEXT_ALIGN_CENTER);
	...
	lv_obj_set_scrollbar_mode(ui->Wifi_screen_Wifi_sw, LV_SCROLLBAR_MODE_OFF);
	...
	lv_style_set_border_color(&style_wifi_screen_wifi_sw_main_main_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_border_width(&style_wifi_screen_wifi_sw_main_main_default, 0);
	lv_style_set_border_opa(&style_wifi_screen_wifi_sw_main_main_default, 255);
	...
	lv_style_set_border_color(&style_wifi_screen_wifi_sw_main_indicator_checked, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_border_width(&style_wifi_screen_wifi_sw_main_indicator_checked, 0);
	lv_style_set_border_opa(&style_wifi_screen_wifi_sw_main_indicator_checked, 255);
	...
	lv_style_set_border_color(&style_wifi_screen_wifi_sw_main_knob_default, lv_color_make(0x21, 0x95, 0xf6));
	lv_style_set_border_width(&style_wifi_screen_wifi_sw_main_knob_default, 0);
	lv_style_set_border_opa(&style_wifi_screen_wifi_sw_main_knob_default, 255);
	...
	lv_style_set_text_line_space(&style_wifi_screen_wifi_name_now_label_main_main_default, 0);
	...
	lv_obj_set_scrollbar_mode(ui->Wifi_screen_btn_1, LV_SCROLLBAR_MODE_OFF);
	...
	lv_style_set_text_color(&style_wifi_screen_btn_1_main_main_default, lv_color_make(0x00, 0x00, 0x00));
	lv_style_set_text_font(&style_wifi_screen_btn_1_main_main_default, &lv_font_simsun_12);
	lv_style_set_text_align(&style_wifi_screen_btn_1_main_main_default, LV_TEXT_ALIGN_CENTER);
