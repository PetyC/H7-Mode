...
DEPPATH += --dep-path $(LVGL_DIR)/$(LVGL_DIR_NAME)/src/extra/widgets/analogclock
...
DEPPATH += --dep-path $(LVGL_DIR)/$(LVGL_DIR_NAME)/src/extra/widgets/carousel
...
DEPPATH += --dep-path $(LVGL_DIR)/$(LVGL_DIR_NAME)/src/extra/widgets/dclock
...
DEPPATH += --dep-path $(LVGL_DIR)/$(LVGL_DIR_NAME)/src/extra/widgets/radiobtn
...
CFLAGS += "-I$(LVGL_DIR)/$(LVGL_DIR_NAME)/src/extra \
           ...
           -I$(LVGL_DIR)/$(LVGL_DIR_NAME)/src/extra/others/gridnav \
           -I$(LVGL_DIR)/$(LVGL_DIR_NAME)/src/extra/others/monkey \
           -I$(LVGL_DIR)/$(LVGL_DIR_NAME)/src/extra/others/snapshot \
           ...
           -I$(LVGL_DIR)/$(LVGL_DIR_NAME)/src/extra/widgets/menu \
           -I$(LVGL_DIR)/$(LVGL_DIR_NAME)/src/extra/widgets/meter \
           -I$(LVGL_DIR)/$(LVGL_DIR_NAME)/src/extra/widgets/msgbox \
           -I$(LVGL_DIR)/$(LVGL_DIR_NAME)/src/extra/widgets/radiobtn \
